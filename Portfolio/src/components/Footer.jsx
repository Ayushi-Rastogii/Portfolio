        ...
        <div className="container">
          <ul className="list-unstyled d-flex flex-column flex-sm-row justify-content-center">
              <li>
                ...
                </li><li className="mx-0 mx-sm-3 my-2 my-sm-0">
                ...
                <li className="mx-0 mx-sm-3 my-2 my-sm-0">
                <a href="#experience" className="text-light text-decoration-none">Work Experience</a>
                </li>
                <li className="me-0 me-sm-3 mb-2 md-sm-0">
                <a href="#projects" className="text-light text-decoration-none">Projects</a>
               </li>
                <li className="mx-0 mx-sm-3 my-2 my-sm-0">
                <a href="#publication" className="text-light text-decoration-none">Publications</a>
                </li>
               <li> <a href="#contact" className="text-light text-decoration-none">Contact</a>
              </li>
          </ul>
